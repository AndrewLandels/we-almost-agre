export function AboutPage() {
  return (
    <div className="wrap about-prose">
      ...
      <ul>
        <li>
          Homepage loop: statement → several closest and trending live matches (prediction markets,
          shares, indices, and similar) → paper long/short on a shared book. Not a single S&amp;P proxy.
        </li>
        <li>
